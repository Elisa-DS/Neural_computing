...
%Load splitted data it contains training and testing  
...
box = [0.2, 0.4, 0.5]; %these values are based on literature
polynomialOrder = [2,3,4];% in case of polynominal check order
...
%just in case the kernel is a polynomial%           
    else 
...
bestBox = str2num(best_model{2,2});
